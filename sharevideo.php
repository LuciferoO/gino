...
switch($_GET['share_type']) {
	case "TWITTER":
		...
		$url="http://www.twitter.com/share?text=".urlencode("We love cheering from the stands, come rain or shine! #YouAreFootball ")."&url=".$photo['shorturl'];
	break;
	case "FACEBOOK":
		$incrementfield="facebook_share";
		$url="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.barclaysyouarefootball.uk.com%2Ffbvideo%2F".$user['urn'];
	break;
	default:
		die("direct access not allowed");
	break;
