...
<div style="width:100%;margin-left:auto;margin-right:auto;"><div style="text-align:center;width:100%;padding-bottom:30px;margin-bottom:30px;border-bottom:4px solid #F383C3;"><img src="/emailer/logo_page.gif" width="242" height="245" alt="Sunglass Hut" /></div>
  ...
  <div style="text-align:center;margin-top:30px;"><a href="http://sunglasshut.wassermanexperience.com/download.php?filename=<?php echo $row_photo['filename']; ?>"><img style="border:none;" src="/emailer/downloadphoto.gif" width="289" height="56" alt="download photo" /></a></div>
</div>
<script>
